...
/**
 * Общие строковые значения для тестов и фабрик данных.
 * Ожидаемые payload'ы и доменные якоря — здесь; уникальные имена — через {@link com.teamcity.core.utils.TestDataFactory}.
 */
